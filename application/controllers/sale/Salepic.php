...
function Getuser_ordering()
   {
echo  $this->salepage_model->Getuser_ordering();
}

function Getuser_ordering_table()
    {

$data = json_decode(file_get_contents("php://input"),true);
echo  $this->salepage_model->Getuser_ordering_table($data);

	}

function Saveuser_ordering()
    {

$data = json_decode(file_get_contents("php://input"),true);
echo  $this->salepage_model->Saveuser_ordering($data);

	}



function Discountcategory_ok()
    {

$data = json_decode(file_get_contents("php://input"),true);
echo  $this->salepage_model->Discountcategory_ok($data);
...
echo  $this->salepage_model->Printproductlisttable($data);
  ...
  function Sale_table_discount_last()
    {

$data = json_decode(file_get_contents("php://input"),true);
echo  $this->salepage_model->Sale_table_discount_last($data);
