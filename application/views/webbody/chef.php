...
<div class="tab-content">
  <div id="new" class="tab-pane fade in active">
    ...
    ເລີ່ມເຮັດ
		...
		<button ng-if="printer_ul =='0'" class="btn btn-lg btn-success" ng-click="Changestatususb('2',x)" style="font-size:30px;font-weight:bold;">
		ສຳເລັດ
		</button>
