...
<div class="col-md-4">
		...
		<thead style="background-color:orange;color:#fff;">
			<tr><td colspan="5" class="text-center">
<b>({{list_doing.length}}) ກຳລັງເຮັດ</b>
			</td>
		</tr>
			<tr>
				<th>ໂຕະ</th>
...
<div class="col-md-4">
	...
	<thead style="background-color:green;color:#fff;">
		<tr><td colspan="5" class="text-center">
<b>({{list_success.length}}) ສຳເລັດ</b>
		</td>
	</tr>
	<tr>
			<th>ໂຕະ</th>
  ...
  {{dataprint.adddate}}
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary"  ng-click="printDiv()">ພິມ</button>
