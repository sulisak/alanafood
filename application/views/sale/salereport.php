...
<div class="form-group">
	<select class="form-control" ng-model="product_category_id" ng-change="reportdaylist()" ng-disabled="shift_id!=''">
...
<div class="form-group">
<input type="text" ng-model="shift_id" class="form-control" placeholder="กะ"  style="width:100px;">
</div>
<div class="form-group">
...
<table ng-hide="showloading" id="headerTable" class="table table-hover table-bordered">
	...
	<tbody>
		...
		<tr>
			<td colspan="5">
			<button class="btn btn-default" ng-click="Opendiscountlastlist()">	ສ່ວນຫຼຸດທ້າຍບິນ ຈາກການຂາຍສິນຄ້າ
			</button>
			</td>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">ລາຄາຂາຍສິນຄ້າ {{data_product_name}}</h4>
			</div>
...
<div class="modal fade" id="opendiscountlastlist">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">ສ່ວນຫຼຸດທ້າຍບິນ</h4>
			</div>
			<div class="modal-body">
