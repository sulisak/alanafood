            ...
            <table id="headerTable" class="table table-hover table-bordered">
                <thead>
                    <tr class="trheader" style="font-size:12px;">
                        ...
                        <th>ເວລາທີ່ເປີດກະ</th>
                        <th>ເວລາທີ່ປິດກະ</th>
                        <th>ເງິນລີ້ນຊັກເລີ່ມ</th>
                        <th>ເງິນລີ້ນຊັກສຸດທ້າຍ</th>
                        <th>ສ່ວນຕ່າງເງິນລີ້ນຊັກ</th>
                ...
                <tbody>
                    <tr ng-repeat="x in list">
                        ...
                        <td>
                            <button class="btn btn-sm btn-default" ng-click="Openbillcloseday(x)">ພິມ</button>
                        ...
                        <td style="color:#fff;background-color:#f0ad4e;text-align:right;">
                            {{x.sumsale_price-x.discount_last | number:2}}</td>

                        <td style="text-align:right;">{{x.cash  | number:2}}</td>
                        ...
                        <td style="color:#fff;background-color:#f0ad4e;text-align:right;">{{x.addwallet  | number:2}}
                        </td>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            ລາຍການອາຫານທີ່ຂາຍໄດ້ໃນກະທີ {{shift_this | number}}
 ...
 <button type="submit" ng-click="Openbillcloseday()" class="btn btn-success" placeholder="" title="<?=$lang_search?>"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
                            ...
                            <div id="section-to-print">
                                <center>
                                    ...
                                    <br />
                                    ເລີ່ມ: {{shift_start_time}}
                                    <br />
                                    ເຖິງ: {{shift_end_time}}
                                    <br />
                                    ..............................
                                    <br />
                                    ເງິນລີ້ນຊັກສຸດທ້າຍ {{shift_money_end | number:2}}
                                    <br /> ເງິນເລີ່ມຕົ້ນ {{shift_money_start | number:2}}
                                    <br />= ສ່ວນຕ່າງ {{shift_money_end-shift_money_start | number:2}}
