...
<li style="width: 100%;" <?php if($tab === 'product_point'){ echo 'class="active"';} ?> ><a href="<?php echo $base_url; ?>/salesetting/product_point"><span class="glyphicon glyphicon-flash" aria-hidden="true"></span> ຕັ້ງຄ່າຄະແນນແລກສິນຄ້າ </a></li>
