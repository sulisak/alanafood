...
<button class="btn btn-primary" ng-click="Openmodal()">ເພີ່ມບັນຊີຜູ້ເຂົ້າໃຊ້ງານ +</button>
<hr />
...
<span ng-if="x.user_type=='1'">ພະນັກງານຂາຍ cashier</span>
<span ng-if="x.user_type=='9'">ພະນັກງານຮັບອໍເດີ</span>
<span ng-if="x.user_type=='10'">ໜ້າຈໍສັ່ງອາຫານຂອງລູກຄ້າ (ໂຕະ {{x.food_table_name}})</span>
<span ng-if="x.user_type=='2'">ພະນັກງານສະຕ໋ອກຮ້ານ</span>
<span ng-if="x.user_type=='15'">ໜ້າຈໍ Chef (ຄົວ {{x.kitchen_name}})</span>
<span ng-if="x.user_type=='20'">ໜ້າຈໍ ສະຖານະການແຕ່ງອາຫານທັງໝົດ</span>
...
<fieldset ng-show="listbrand.length != '0'">
                    <div class="form-group">
                    	ຊື່
		<input class="form-control" placeholder="ຊື່" ng-model="user_name" type="text" style="height: 50px;font-size: 20px;">
			    		</div>
...
<div class="form-group">
	<select ng-disabled="user_id=='1'" id="" class="form-control" ng-model="user_type" style="height: 50px;font-size: 20px;">
		...
		<option value="1">ພະນັກງານຂາຍ cashier</option>
			<option value="9">ພະນັກງານຮັບອໍເດີ</option>
		<option value="2">ພະນັກງານສະຕ໋ອກຮ້ານ</option>
			<option value="10">ໜ້າຈໍສັ່ງອາຫານຂອງລູກຄ້າ</option>
			<option value="15">ໜ້າຈໍ Chef</option>
			<option value="20">ໜ້າຈໍ ສະຖານະການແຕ່ງອາຫານທັງໝົດ</option>
...
<option value="0">ເລືອກໂຕະ</option>
...
<option value="0">ເລືອກຄົວ</option>
...
<div class="form-group">
	User Login:
			    		...
			    		<input id="submit" class="btn btn-lg btn-success btn-block" type="submit" ng-click="Adduser()" value="ບັນທຶກ" ng-hide="foredit">

<input id="submit" class="btn btn-lg btn-success btn-block" type="submit" ng-click="Edituser()" value="ຢືນຢັນ" ng-show="foredit">
