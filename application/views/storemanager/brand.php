...
<button class="btn btn-default" ng-click="Updatelogomodal(x)">ອັບໂຫຼດໂລໂກ</button>
...
<br />
	<span ng-if="x.owner_vat_status!='0'">	{{x.owner_vat}} % </span>
		...
		<input type="text" class="form-control" ng-model="x.footer_slip" placeholder="ໃສ່ຂໍ້ຄວາມສ່ວນລຸ່ມໃບບິນ...">
					</td>
					<td>
			<button class="btn btn-success" ng-click="Updatefooter_slip(x)">ບັນທຶກສ່ວນລຸ່ມໃບບິນ</button>
...
<button class="btn btn-default" ng-click="Updatebgimgmodal(x)">ອັບໂຫຼດພາບພື້ນຫຼັງ</button>
<hr />
...
<div class="form-group">
			    			<select  class="form-control" style="height: 50px;font-size: 20px;" ng-model="owner_vat_status">
			    				...
			    				<option value="2">ພາສີແຍກໃນສິນຄ້າ VAT Exclude</option>
			    			</select>
			    		</div>
