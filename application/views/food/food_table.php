...
<th><?=$lang_tablename?></th><th>ຈຳນວນ<?=$lang_seat?></th><th style="width: 120px;"><?=$lang_manage?></th>
		</tr>
	</thead>
	<tbody>
	<tr style="background-color:#eee;">
...
<input type="text" class="form-control" placeholder="<?=$lang_tablename?>" ng-model="food_table_name" style="font-size:20px;">
			...
			<td>
				<input type="text" class="form-control" placeholder="ຈຳນວນ<?=$lang_seat?>" ng-model="food_table_seat" style="font-size:20px;">
			</td>
