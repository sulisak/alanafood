...
<br />
*** ເຊັ່ນ ຮ້ອນ, ເຢັນ, ປັ່ນ, ເພີ່ມຊອດ, ຄີມ, ແກ້ວນ້ອຍ  ກາງ,ເສັ້ນນ້ອຍ ເສັ້ນໃຫຍ່, ເຜັດ ຫວານ ສຸກ ດິບ ອື່ນໆ<font color="red">(ບໍ່ຕັດສະຕ໋ອກ)</font>
<br />
...
<table id="headerTable" class="table table-hover table-bordered" style="font-size: 14px;">
	<thead>
		<tr style="background-color: #eee;">
			...
			<th style="text-align: center;width: 100px;">ຊື່ອ໋ອບຊັນ</th>
			<th style="text-align: center;width: 100px;">ລາຄາທີ່ຈະເພີ່ມຂຶ້ນ</th>
...
ຊື່ອ໋ອບຊັນ
<input type="text" name="product_ot_name"  placeholder="ຊື່ອ໋ອບຊັນ" class="form-control" required="required">
<p></p>
...
ຊື່ອ໋ອບຊັນ
<input type="text" name="product_ot_name" id="product_ot_name" placeholder="ຊື່ອ໋ອບຊັນ" class="form-control" required="required">
