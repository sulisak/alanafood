...
<?=$lang_search?>ຊື່ວັດຖຸດິບ" ng-change="getlist(searchtext,'1')">
</div>
...
<table id="headerTable" class="table table-hover table-bordered">
	...
	<!-- 	<th style="text-align: center;">รหัส</th> -->
			<th style="text-align: center;">ຊື່ວັດຖຸດິບ</th>

			<th style="text-align: center;"><?=$lang_total?>(ໜ່ວຍ)</th>
			<!-- <th style="text-align: center;"><?=$lang_total?>(ขีด)</th>
			<th style="text-align: center;"><?=$lang_total?>(กิโลกรัม)</th> -->
<?php if($_SESSION['user_type']=='4'){?>
			<th style="text-align: center;width: 50px;">ແກ້ໄຂຈຳນວນວັດຖຸດິບ</th>
		<?php } ?>
