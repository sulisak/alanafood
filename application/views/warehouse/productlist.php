...
<?=$lang_search?> ຊື່ອາຫານ,ໝວດໝູ່" ng-change="getlist(searchtext,'1')">
</div>
	...
	<thead>
		<tr style="background-color: #eee;">
			<th style="width: 50px;"><?=$lang_rank?></th>
			 <th style="text-align: center;width: 10px;">Barcode/<?=$lang_barcode?></th>


			<th style="text-align: center;width: 150px;"><?=$lang_picproduct?></th>
			<th style="text-align: center;width: 100px;"><?=$lang_productname?></th>
			<th style="text-align: center;width: 50px;">ຈຳນວນ</th>
			<th style="text-align: center;">ເພີ່ມຈຳນວນ</th>
			<!-- <th style="text-align: center;">ออฟชั่นเสริม</th> -->
			<th style="text-align: center;width: 30px;">ວັດຖຸດິບ/ສ່ວນປະກອບ</th>
...
<div class="modal fade" id="additemmodal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">ເພີ່ມຈຳນວນສິນຄ້າ {{matdata.product_name}}</h4>
			</div>
			<div class="modal-body">
...
<br />
<button class="btn btn-success" ng-click="Additemok()">ບັນທຶກ</button>
...
<div class="modal fade" id="materialmodal">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">ລາຍການວັດຖຸດິບຂອງ {{productmatdata.product_name}} </h4>
			</div>
			<div class="modal-body">
<font color="red">(ຕັດສະຕ໋ອກ)</font>
<input type="text" ng-model="searchmattext" class="form-control" placeholder="ຄົ້ນຫາວັດຖຸດິບ ເຊັ່ນ ເນື້ອ$ູ" ng-change="Getlistmat(searchmattext)">
...
<td>
	<button ng-click="Deletematerial(x)" class="btn btn-default">ລຶບ</button>
</td>
		</tr>
